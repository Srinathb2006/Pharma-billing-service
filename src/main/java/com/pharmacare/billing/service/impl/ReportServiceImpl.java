...
public class ReportServiceImpl implements ReportService {
        ...
        public ReportServiceImpl(MongoTemplate mongoTemplate, BillRespository billRepository) {
        ...
        public double getTotalSales(SalesReportRequest request) {
                ...
                return billRepository.findByCreatedAtBetweenAndPaymentStatus(start, end, "PAID")
                                .stream()
